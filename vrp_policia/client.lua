...
-- CHECKCOORDS POLICIA
-----------------------------------------------------------------------------------------------------------------------------------------
function src.checkCoordsPolicia(x,y,z)
    local distance1 = GetDistanceBetweenCoords(x,y,z,448.88,-983.68,30.69,true)
    local distance2 = GetDistanceBetweenCoords(x,y,z,-447.48,6013.38,31.72,true)
    if distance1 <= 10 or distance2 <= 10 then
        return true
    end
    return false
end
...
-- CHECKCOORDS CMDL
-----------------------------------------------------------------------------------------------------------------------------------------
function src.checkCoordsCMDL(x,y,z)
	local distance1 = GetDistanceBetweenCoords(x,y,z,312.67,-593.25,43.3,true)
	local distance2 = GetDistanceBetweenCoords(x,y,z,-264.16,6316.05,32.44,true)
    if distance1 <= 10 or distance2 <= 10 then
        return true
    end
    return false
