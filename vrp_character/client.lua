RegisterNetEvent("vrp_character:normalSpawn")
RegisterNetEvent("vrp_character:characterCreate")
...
AddEventHandler("vrp_character:characterCreate",function()
	doStatus = 1
...
AddEventHandler("vrp_character:normalSpawn",function(firstspawn)
	if firstspawn then
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		SetPedComponentVariation(PlayerPedId(),1,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),3,28,0,2)
		SetPedComponentVariation(PlayerPedId(),4,63,0,2)
		SetPedComponentVariation(PlayerPedId(),6,24,0,2)
		SetPedComponentVariation(PlayerPedId(),8,15,0,2)
		SetPedComponentVariation(PlayerPedId(),6,16,0,2)
		SetPedComponentVariation(PlayerPedId(),11,115,0,2)
		SetPedComponentVariation(PlayerPedId(),9,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),10,-1,0,2)
		SetPedPropIndex(PlayerPedId(),0,7,2,2)
		...
		SetPedPropIndex(PlayerPedId(),1,20,0,2)
		SetPedPropIndex(PlayerPedId(),2,-1,0,2)
		SetPedPropIndex(PlayerPedId(),6,-1,0,2)
		SetPedPropIndex(PlayerPedId(),7,-1,0,2)
	end

	SetEntityCoordsNoOffset(PlayerPedId(),-844.30,-133.19,28.18,true,true,true)
	...
	TriggerServerEvent("vrp_character:finishedCharacter",characterNome,characterSobrenome,characterAge,currentCharacterMode)
end)
