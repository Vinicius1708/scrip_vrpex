...
local garages = {
	...
	[16] = { ['name'] = "PoliciaPC", ['payment'] = false, ['perm'] = "pcivil.permissao" },
	[17] = { ['name'] = "PMERJ", ['payment'] = false, ['perm'] = "pmerj.permissao" },
	[18] = { ['name'] = "RECOM", ['payment'] = false, ['perm'] = "recom.permissao" },
	[19] = { ['name'] = "BPCHQ", ['payment'] = false, ['perm'] = "bpchq.permissao" },
	[42] = { ['name'] = "PoliciaHeli", ['payment'] = true, ['perm'] = "policiaheli.permissao" },

	[20] = { ['name'] = "PFEDERAL", ['payment'] = false, ['perm'] = "pfederal.permissao" },
	[21] = { ['name'] = "BOPE", ['payment'] = false, ['perm'] = "bope.permissao" },
	[22] = { ['name'] = "PRF", ['payment'] = false, ['perm'] = "prf.permissao" },
	...
	[60] = { ['name'] = "PRF", ['payment'] = true, ['perm'] = "prf.permissao" },
	[61] = { ['name'] = "PRF", ['payment'] = true, ['perm'] = "prf.permissao" },
	[62] = { ['name'] = "PRF", ['payment'] = true, ['perm'] = "prf.permissao" },

	[63] = { ['name'] = "Mafia", ['payment'] = true, ['perm'] = "mafia.permissao" },
-----------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------FORTHILLS-----------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
