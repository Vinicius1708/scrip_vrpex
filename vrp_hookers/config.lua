...
Config.BlowjobPrice			= 10000  	-- valor para boquete
Config.SexPrice				= 15000  	-- valor para sexo
Config.SocietyNightclub		= false 

Config.PimpGuy = {
    { x= 130.43, y= -1324.84, z= 28.21, name = "Pimp", heading = 304.47, model = "s_m_m_bouncer_01" }, -- local do cafetao (ped)
}

Config.Zones = {
	["Pimp"] = {
		Pos   = { x= 130.43, y= -1324.84, z= 28.21 }, -- local do cafetao
	},
} 
-- local onde as putas brota
Config.Hookerspawns = {
